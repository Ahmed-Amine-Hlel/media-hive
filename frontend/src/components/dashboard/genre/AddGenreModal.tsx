...
import useGenre from "@/hooks/genre/useGenre";  // Make sure you have the hook to handle genre state
...
const AddGenreModal = () => {
    ...
    const {saveGenreToState} = useGenre();  // Adjust according to your genre hook
